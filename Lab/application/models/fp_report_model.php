...
class Fp_report_model extends CI_Model
{
    ...
    function get_central_contraceptive_level_periods()
    {
    ...
    public function forecast_contraceptive_variance_tracker($period)
    {
        ...
        (SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id='to0Pssxkq4S' AND period='{$period}' AND drug_id=cid )as actual_consumption,
        (SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id='to0Pssxkq4S' AND period='{$period1}' AND drug_id=cid )as actual_consumption1,
        (SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id='to0Pssxkq4S' AND period='{$period2}' AND drug_id=cid )as actual_consumption2,
        (SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id='to0Pssxkq4S' AND period='{$period3}' AND drug_id=cid )as actual_consumption3,
        (SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id='to0Pssxkq4S' AND period='{$period4}' AND drug_id=cid )as actual_consumption4,
        (SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id='to0Pssxkq4S' AND period='{$period5}' AND drug_id=cid )as actual_consumption5 
    ...
    function get_national_level_mos($period)
    {
        ...
        ( 
          ( 
            ( 
              (
                (SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period}') / 
                (SELECT facility_level_reporting_rates.reporting_rate_value FROM contraceptive_facility_level_reporting_rates WHERE period = '{$period}')
                )*100
              )
            )/1
        ...
        if(central_level_period_exists($period1)==true)
        {
            ...
            (
              (
                (
                  ((SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period}') / 
                    (SELECT facility_level_reporting_rates.reporting_rate_value FROM contraceptive_facility_level_reporting_rates WHERE period = '{$period}'))*100)+(
                    ((SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period1}') / 
                    (SELECT facility_level_reporting_rates.reporting_rate_value FROM contraceptive_facility_level_reporting_rates WHERE period = '{$period1}'))*100
                    )
                  )/2 
                          ...
                          (
                            ...
                            ((SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period1}') / 
                              (SELECT facility_level_reporting_rates.reporting_rate_value FROM contraceptive_facility_level_reporting_rates WHERE period = '{$period1}'))*100
                                ...
                                +
                                (
                            ( (SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period2}') / 
                              (SELECT facility_level_reporting_rates.reporting_rate_value FROM contraceptive_facility_level_reporting_rates WHERE period = '{$period2}'))*100
                                )
                          ...
                          (
                            ...
                            ( (SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period2}') / 
                              (SELECT facility_level_reporting_rates.reporting_rate_value FROM contraceptive_facility_level_reporting_rates WHERE period = '{$period2}'))*100
                                  ...
                                  +
                                  (
                            ((SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period3}') / 
                              (SELECT facility_level_reporting_rates.reporting_rate_value FROM contraceptive_facility_level_reporting_rates WHERE period = '{$period3}'))*100
                                    )
        ...
        if(central_level_period_exists($period4)==true)
        {
            $query="SELECT commodity_id  AS com_id, soh  AS central_stock,
                    ...
                    (
                      (
                        (
                          ((SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period}') / (SELECT facility_level_reporting_rates.reporting_rate_value FROM contraceptive_facility_level_reporting_rates WHERE period = '{$period}'))*100
                        )
                        +
                        (
                          ((SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period1}') / (SELECT facility_level_reporting_rates.reporting_rate_value FROM contraceptive_facility_level_reporting_rates WHERE period = '{$period1}'))*100
                        )

                        +
                        (
                          ( (SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S'  AND drug_id = com_id  AND period = '{$period2}') / (SELECT facility_level_reporting_rates.reporting_rate_value FROM contraceptive_facility_level_reporting_rates WHERE period = '{$period2}'))*100
                        )
                        +
                        (
                          ((SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period3}') / (SELECT facility_level_reporting_rates.reporting_rate_value FROM contraceptive_facility_level_reporting_rates WHERE period = '{$period3}'))*100
                       )
                       +
                       (
                         ((SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period4}') / (SELECT facility_level_reporting_rates.reporting_rate_value FROM contraceptive_facility_level_reporting_rates WHERE period = '{$period4}'))*100
                        )
                          ...
                          (
                            ...
                            ((SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period1}') / (SELECT facility_level_reporting_rates.reporting_rate_value FROM contraceptive_facility_level_reporting_rates WHERE period = '{$period1}'))*100
                             ...
                             (
                              ...
                              +
                              (                       
                              ((SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period5}') / (SELECT facility_level_reporting_rates.reporting_rate_value FROM contraceptive_facility_level_reporting_rates WHERE period = '{$period5}'))*100
                                )
                                )/6
                                ) AS adjusted_facility_amc FROM contraceptive_current_stock WHERE period = '{$period}'";
            }
...
WHERE period = '{$period}'";
  ...
  drug_value
         FROM contraceptive_facility_level_data
         WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period1}')
      )
      ...
      +
      (
        (SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period4}')
      )
        ...
        if(central_level_period_exists($period5)==true)
        {
            $query="SELECT  commodity_id AS com_id,soh  AS central_stock,
                ...
                (
                      ...
                      +
                      (
                        (SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S  AND drug_id = com_i  AND period = '{$period4}')
                      )
                      +
                      (
                        (SELECT drug_value FROM contraceptive_facility_level_data WHERE drug_category_id = 'to0Pssxkq4S' AND drug_id = com_id AND period = '{$period5}')
                      )
                    )/6
                  )AS adjusted_facility_amc FROM contraceptive_current_stock WHERE period = '{$period}'";
